...
{
	public partial class WhiteSquare : PositionedObject, IDestroyable
	{
        ...
        public WhiteSquare(string contentManagerName) :
            this(contentManagerName, true)
        {
        }


        public WhiteSquare(string contentManagerName, bool addToManagers) :
			base()
		{
			// Don't delete this:
...
// Generated AddToManagers
		...
		public static void LoadStaticContent (string contentManagerName)
		{
			...
			if (IsStaticContentLoaded == false)
			{
				...
				lock (mLockObject)
				{
					...
					{
						FlatRedBallServices.GetContentManagerByName(ContentManagerName).AddUnloadMethod("WhiteSquareStaticUnload", UnloadStaticContent);
						mHasRegisteredUnload = true;
					}
				}
				bool registerUnload = false;
				if (!FlatRedBallServices.IsLoaded<Scene>(@"content/entities/whitesquare/scenefile.scnx", ContentManagerName))
				{
					registerUnload = true;
				}
				SceneFile = FlatRedBallServices.Load<Scene>(@"content/entities/whitesquare/scenefile.scnx", ContentManagerName);
	...
	// Extra classes
	public static class WhiteSquareExtensionMethods
	{
	}
